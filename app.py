"""Brazil Item Coding Studio - Streamlit Web Version"""
...
# ---------------------------------------------------------------------------
st.sidebar.title("🛠️ RPA & Controls")
...
if st.sidebar.button("⚡ Run Batch Auto-Code", type="primary", use_container_width=True):
...
# MAIN WORKSPACE
# ---------------------------------------------------------------------------
st.title("🇧🇷 Brazil Item Coding Studio — Web Dashboard")
...
st.markdown("---")
st.subheader("✨ Single-Row Extraction Utility")
